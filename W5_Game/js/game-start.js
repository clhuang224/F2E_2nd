...
const gameStart = {
    key: 'gameStart',
    preload: function () {
        this.load.image('img-title', '../img/img-title.svg');
        this.load.image('text-title', '../img/txt-title.svg');
        this.load.image('text-subtitle', '../img/txt-subtitle.svg');
        this.load.image('button','../img/btn-press-start.svg');
    },
    create: function () {
        ...
        this.textSubitle = this.add.image(846.41+272.14 / 2, 480.77 + 24 / 2, 'text-subtitle');
